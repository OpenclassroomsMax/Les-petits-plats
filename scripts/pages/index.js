...
export function displayData(data) {
  ...
  data.forEach((recipes) => {
    ...
    recipesSectionCards.innerHTML =
      recipesSectionCards.innerHTML + recipesCardDOM;
  });
}
export function filterIngredientsDOM() {
  const filtersIngredientsSection = document.querySelector(
    ".filters__ingredients"
  );
  const filterModel = new FilterInterface(recipes);
  const filterDOM = filterModel.filterIngredients();
  filtersIngredientsSection.innerHTML =
    filtersIngredientsSection.innerHTML + filterDOM;
}
export function filterIngredientsEvent() {
  ...
  const titleIngredients = document.querySelector(
    ".filter__ingredients--title"
  );
  const chevronDownIngredients = document.querySelector(
    ".filter__ingredients--chevronDown"
  );
  const chevronUpIngredients = document.querySelector(
    ".filter__ingredients--chevronUp"
  );
  ...
  chevronDownIngredients.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-down filter__ingredients--chevronDown"
    ) {
  ...
  chevronUpIngredients.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-up filter__ingredients--chevronUp"
    ) {
...
export function filterAppareilsDOM() {
  const filtersAppareilsSection = document.querySelector(
    ".filters__appliances"
  );
  const filterModel = new FilterInterface(recipes);
  const filterDOM = filterModel.filterAppareils();
  filtersAppareilsSection.innerHTML =
    filtersAppareilsSection.innerHTML + filterDOM;
}
...
export function filterAppliancesEvent() {
  ...
  const chevronDownAppliances = document.querySelector(
    ".filter__appliances--chevronDown"
  );
  const chevronUpAppliances = document.querySelector(
    ".filter__appliances--chevronUp"
  );
  ...
  chevronDownAppliances.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-down filter__appliances--chevronDown"
    ) {
  ...
  chevronUpAppliances.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-up filter__appliances--chevronUp"
    ) {
...
export function filterUstensilsDOM() {
  ...
  filtersUstensilsSection.innerHTML =
    filtersUstensilsSection.innerHTML + filterDOM;
}
export function filterUstensilsEvent() {
  ...
  const chevronDownUstensils = document.querySelector(
    ".filter__ustensils--chevronDown"
  );
  const chevronUpUstensils = document.querySelector(
    ".filter__ustensils--chevronUp"
  );
  ...
  chevronDownUstensils.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-down filter__ustensils--chevronDown"
    ) {
  ...
  chevronUpUstensils.addEventListener("click", (e) => {
    if (
      e.target.className ===
      "fa-solid fa-chevron-up filter__ustensils--chevronUp"
    ) {
...
export function generateDropBox(data) {
  ...
  data.forEach((recipe) => {
    ...
    recipe.ingredients.forEach((ingredient) => {
      ...
      if (
        ingredientListTri.includes(ingredient.ingredient) === false &&
    ...
    if (
      appliancesListTri.includes(recipe.appliance) === false &&
      atags.includes(recipe.appliance) === false
      
    ) {
      appliancesListTri.push(recipe.appliance.toLowerCase());
    ...
    recipe.ustensils.forEach((ustensil) => {
      if (
        ustensilsListTri.includes(ustensil) === false &&
  ...
  appliancesListTri.sort();
  let applianceListTriUnique = [...new Set(appliancesListTri)];
  applianceListTriUnique.forEach((appliance) => {
  const filterListAppliances = document.createElement("li");
  filterListAppliances.classList.add("filter__appliances--items");
  filterListAppliances.innerText = appliance;
